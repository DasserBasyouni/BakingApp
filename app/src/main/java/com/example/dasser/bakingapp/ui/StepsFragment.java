...
public class StepsFragment extends Fragment implements LoaderManager.LoaderCallbacks{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        getLoaderManager().initLoader(LOADER_ID_DETAIL_ACTIVITY, savedInstanceState, this);
        return view;
    }

    private void setupRecyclerViews(RecipeIngredientsAndStepsCombination data) {
        ...
        ingredientsRV.setAdapter(new IngredientRecyclerViewAdapter(data.getIngredients()));

        stepsRV.setLayoutManager(new LinearLayoutManager(getActivity()));
        stepsRV.setAdapter(new StepsRecyclerViewAdapter(data.getSteps()));
    }
    ...
    public void onLoadFinished(@NonNull Loader loader, Object data) {
        setupRecyclerViews((RecipeIngredientsAndStepsCombination) data);
    }
    ...
    public static class GetRecipesDetails extends AsyncTaskLoader<RecipeIngredientsAndStepsCombination> {
        ...
        public RecipeIngredientsAndStepsCombination loadInBackground() {
            ...
            return new RecipeIngredientsAndStepsCombination(
